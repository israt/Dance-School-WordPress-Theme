...
function dynasty3_widgets_init() {
	...
	register_sidebar( array(
		...
		'name'          => __( 'Class Dance Styles', 'dynasty3' ),
    ...
    register_post_type( 'slider',  
        ...
        array(  
          ...
          //  'rewrite' => array('slug' => 'single-medical-gallery'),
            ...
            'supports' => array('title','thumbnail','wps_subtitle','custom-fields') 
    ...
    register_post_type( 'gallery',  
        ...
        array(  
            ...
            'labels' => array(  
                ...
                'name' => __( 'Photo Gallery' , 'dynasty3'),

                'singular_name' => __( 'Photo Gallery' , 'dynasty3'), 

                'add_new' => __('Add New Photo', 'dynasty3'),

				'edit_item' => __('Edit Photo', 'dynasty3'), 

                'new_item' => __('New Photo', 'dynasty3'),  

                'view_item' => __('View Photo', 'dynasty3'), 

                'search_items' => __('Search Photo', 'dynasty3'), 

                'not_found' => __('No Photo found', 'dynasty3'),

                'not_found_in_trash' => __('No Photo found in Trash', 'dynasty3') 
...
add_action( 'init', 'create_vgallery' );

function create_vgallery() {  

    register_post_type( 'vgallery',  

        array(  

            'labels' => array(  

                'name' => __( 'Video Gallery' , 'dynasty3'),

                'singular_name' => __( 'Video Gallery' , 'dynasty3'), 
    ...
    register_post_type( 'news',  
        ...
        array(  
            ...
            'labels' => array(  
                ...
                'name' => __( 'News' , 'dynasty3'),

                'singular_name' => __( 'News' , 'dynasty3'), 

                'add_new' => __('Add New News', 'dynasty3'),

				'edit_item' => __('Edit News', 'dynasty3'), 

                'new_item' => __('New News', 'dynasty3'),  

                'view_item' => __('View News', 'dynasty3'), 

                'search_items' => __('Search News', 'dynasty3'), 

                'not_found' => __('No News found', 'dynasty3'),

                'not_found_in_trash' => __('No News found in Trash', 'dynasty3') 
