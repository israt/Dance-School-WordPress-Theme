...
//////////////GENERAL SETTINGS START/////////////////////////
	...
	$options[] = array(
		'name' => __('Hotspot 1 Image', 'options_check'),
		'id' => 'hi1',
		'type' => 'upload');	
	...
	$options[] = array(
		'name' => __('Hotspot 1 Link', 'options_check'),
		'id' => 'hl1',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('Hotspot 2 Image', 'options_check'),
		'id' => 'hi2',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('Hotspot 2 Link', 'options_check'),
		'id' => 'hl2',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('Hotspot 3 Image', 'options_check'),
		'id' => 'hi3',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('Hotspot 3 Link', 'options_check'),
		'id' => 'hl3',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('Hotspot 4 Image', 'options_check'),
		'id' => 'hi4',
		'type' => 'upload');
		
	$options[] = array(
		'name' => __('Hotspot 4 Title', 'options_check'),
		'id' => 'h4',
		'type' => 'text');	
		
	$options[] = array(
		'name' => __('Hotspot 4 Content', 'options_check'),
		'id' => 'hc4',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('Hotspot 4 Link', 'options_check'),
		'id' => 'hl4',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('Upload  video Content', 'options_check'),
		'id' => 'video-content',
		'type' => 'editor');
...
//////////////Page Links/////////////////////////
	$options[] = array(
		'name' => __('Page Links', 'options_check'),
		'type' => 'heading');
		
	$options[] = array(
		'name' => __('Online Registration (Children)', 'options_check'),
		'id' => 'p-link1',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('Online Registration (Adults)', 'options_check'),
		'id' => 'p-link2',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('TDC Dance Shop', 'options_check'),
		'id' => 'p-link3',
		'type' => 'text');
...
//////////////Contact Info. starts/////////////////////////
	...
	$options[] = array(
		'name' => __('Email Address(footer)', 'options_check'),
		'id' => 'em-f',
		'type' => 'text');
